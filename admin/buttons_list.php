            ...
            <div class="section-listing">
                <div class="section-options">
                    ...
                    <div class="section-content tab-content" >
                        <div class="alert alert-success" style="display: none;"><b>Success!</b> Your button has saved successfully.</div>       
                            ...
                            <div class="section-cell"  style="box-shadow: none;">
                                <div class="cell-container" style="border-bottom: 1px solid #ebeef0;">
                                    <div class="cell-column">
                                        <a class="btn primary" href="share_button.php?shop=<?= $shop; ?>">Add Share Button</a><br /><br />
                                ...
                                <div class="cell-container">
                                    <table id="cust_data" class="display" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th width="1%" style="text-align:left;">Id</th>
                                                <th width="50%" style="text-align:left">Hidden Content</th>
...
<script>
    ...
    $(document).on('click', '.b_delete', function () {     
		...
		var b_page = $.trim($(curr_obj).attr("b_page"));
    ...
    function load_data(shop_str) {
        ...
        var table = $('#cust_data').DataTable({
            ...
            "order": [[0, "desc"]],
            "columns": [                
                {"data": "bid", "visible": true, "bSortable": true},
                {"data": "b_content"},
                {"data": "bid", "bSortable": false, "targets": 'no-sort', "render": function (data, type, row) {
                        var bid_str_temp = base64_encode(data);                        
                        var b_action_str = '<a href="edit_button.php?id='+bid_str_temp+'&shop='+shop_str+'" class="b_edit"><img src="images/edit.png" alt="" style="max-width: 20px;" /></a>';
                        return b_action_str;
                }},
                {"data": "bid", "bSortable": false, "targets": 'no-sort', "render": function (data, type, row) {
					var bid_str_temp = base64_encode(data);
					var b_product_list = row['b_target_id'];
					var b_page = row['page_id'];
					var b_action_str = '<a href="javascript:void(0)" b_page="'+b_page+'" id="'+bid_str_temp+'" b_pro_list="'+b_product_list+'" class="b_delete"><img src="images/delete.png" alt="" style="max-width: 20px;" /></a>';
					return b_action_str;
				}}
            ],
            "ajax": {
                "url": "ajax.php?shop="+shop_str+"&type=get_button_list",
                "type": "POST"
            }
        });
        return table;
