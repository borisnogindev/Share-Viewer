                                ...
                                <div class="section-cell"  style="box-shadow: none;">
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="text" class="demo input_field" id="bHeading" placeholder="Heading" value="" /> 
                                        </div>
                                    </div>
									...
									<div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
                                            <input type="text" class="demo input_field" id="bSubHeading" placeholder="Sub Heading" value="" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="cell-container">
                                        ...
                                        <div class="cell-column row_field">
											<div><input onclick='$("#page_select").hide();$("#product_select").show();'type="radio" id="selection_target" name="selection_target" value="product"> Product</div>
											 <div><input onclick='$("#page_select").show();$("#product_select").hide();' type="radio" id="selection_target" name="selection_target" value="page"> Page</div>
											...
											<div id="page_select" style="display: none;">
											<div class="op_head">Select Page</div>
											<select class="store_col_list" id="page_id">
												<option value="">Select</option>
												<?php
												if(count($page_list) > 0){
													  for($i=0;$i<count($page_list);$i++){
												?>
													<option value="<?=$page_list[$i]["id"]?>"><?=$page_list[$i]["title"]?></option>
												<?php
													  }
												}
												?>
    ...
    <div class="product_selection_box">
        ...
        <div class="footer_data">
            ...
            <div class="product_selection_buttonbox">
                <input type="button" class="btn primary btnContProducts" value="Continue with Selected Product"  data_for="b_target_products" max-limit="1" />
